...
class LoginModal extends React.Component {
  ...
  logIn = () => {
    ...
    axios.post("https://vortex-b.xyz/api/login/", {
      ...
      if(response.data.status === "success")
      {
        ...
        this.setState({alertText: "Successfully logged in, closing popup in 5 seconds.", alertType: "success"});
          ...
          <Modal.Body style={{backgroundColor: "#212529"}}>
            ...
            <Form>
              ...
              <Form.Group controlId="password">
                ...
                <a href="#" onClick={this.props.openForgotPasswordModal} style={{textDecoration: "none", color: "rgba(255,255,255,.5)"}}>Forgot password?</a>
              </Form.Group>
              <Form.Group>
            ...
            <Button block variant="light" type="submit" onClick={this.state.buttonDisabled ? null : this.logIn} disabled={this.state.buttonDisabled}>
              {this.state.buttonDisabled ? <>Logging in...</> : 'Log in'}
            </Button>
          </Modal.Body>
        </Modal>
      </>
